...
<body style="background: antiquewhite">
    ...
    <div class="container mt-3">
        <?php
        if (isset($_POST['enviar'])) { //hemos enviado el formulario para consultar
            //las unidades
            ...
            $stmt1->fetch(); //esta consulta solo devuelve una fila, no es necesario
            //el while
            $stmt1->close();
            if (!$stmt->execute()) {
            ...
            $stmt->close();
            cerrarConexion();
        } elseif (isset($_POST['enviar1'])) { //Hemos enviado el formulario para
