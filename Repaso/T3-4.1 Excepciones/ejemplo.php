...
<body style="background: antiquewhite">
    ...
    <div class="container mt-3">
        <?php
        if (isset($_POST['enviar']) && !$error) { //hemos enviado el formulario para
            ...
            if (!$error) {
                $fila = $stmt1->fetch(PDO::FETCH_OBJ); //solo nos devuelve una fila
                //es innecesario el while
        ...
        } elseif (isset($_POST['enviar1']) && !$error) { //Hemos enviado el
            //formulario para modificar las unidades
            $codTienda = $_POST['ct'];
